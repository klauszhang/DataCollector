namespace DataCollector.DAL.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DCUser_Id = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.DCUser_Id)
                .Index(t => t.DCUser_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.KeyValueDatas", "UserDevice_Id", "dbo.UserDevices");
            DropForeignKey("dbo.UserDevices", "DCUser_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.UserDevices", new[] { "DCUser_Id" });
            DropIndex("dbo.KeyValueDatas", new[] { "UserDevice_Id" });
